    ...
    <div className={style.courses_container}>
      ...
      <div className={style.chapter_box}>
        ...
        <div className={style.courses}>
          ...
          {/* The Outlet element takes a special prop called context that can be used to pass data to the child routes. This context can then be accessed inside the relevant page using the useOutletContext hook. */}
        </div>
      </div>
    </div>
  );
